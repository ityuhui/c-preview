...
v1alpha1_scheduling_t *v1alpha1_scheduling_create(
    ...
    v1alpha1_scheduling_local_var->node_selector = node_selector;
...
void v1alpha1_scheduling_free(v1alpha1_scheduling_t *v1alpha1_scheduling) {
    ...
    list_ForEach(listEntry, v1alpha1_scheduling->node_selector) {
...
cJSON *v1alpha1_scheduling_convertToJSON(v1alpha1_scheduling_t *v1alpha1_scheduling) {
    ...
    // v1alpha1_scheduling->node_selector
    if(v1alpha1_scheduling->node_selector) { 
    ...
    if (v1alpha1_scheduling->node_selector) {
    list_ForEach(node_selectorListEntry, v1alpha1_scheduling->node_selector) {
...
v1alpha1_scheduling_t *v1alpha1_scheduling_parseFromJSON(cJSON *v1alpha1_schedulingJSON){
    ...
    // v1alpha1_scheduling->node_selector
    cJSON *node_selector = cJSON_GetObjectItemCaseSensitive(v1alpha1_schedulingJSON, "nodeSelector");
