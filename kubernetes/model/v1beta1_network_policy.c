...
v1beta1_network_policy_t *v1beta1_network_policy_create(
    ...
    v1beta1_network_policy_local_var->api_version = api_version;
...
void v1beta1_network_policy_free(v1beta1_network_policy_t *v1beta1_network_policy) {
    ...
    free(v1beta1_network_policy->api_version);
...
cJSON *v1beta1_network_policy_convertToJSON(v1beta1_network_policy_t *v1beta1_network_policy) {
    ...
    // v1beta1_network_policy->api_version
    if(v1beta1_network_policy->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_network_policy->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_network_policy_t *v1beta1_network_policy_parseFromJSON(cJSON *v1beta1_network_policyJSON){
    ...
    // v1beta1_network_policy->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_network_policyJSON, "apiVersion");
    if (api_version) { 
