...
v1beta1_api_service_t *v1beta1_api_service_create(
    ...
    v1beta1_api_service_local_var->api_version = api_version;
...
cJSON *v1beta1_api_service_convertToJSON(v1beta1_api_service_t *v1beta1_api_service) {
    ...
    // v1beta1_api_service->api_version
    if(v1beta1_api_service->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_api_service->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_api_service_t *v1beta1_api_service_parseFromJSON(cJSON *v1beta1_api_serviceJSON){
    ...
    // v1beta1_api_service->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_api_serviceJSON, "apiVersion");
    if (api_version) { 
