...
v1alpha1_runtime_class_list_t *v1alpha1_runtime_class_list_create(
    ...
    v1alpha1_runtime_class_list_local_var->api_version = api_version;
...
cJSON *v1alpha1_runtime_class_list_convertToJSON(v1alpha1_runtime_class_list_t *v1alpha1_runtime_class_list) {
    ...
    if(v1alpha1_runtime_class_list->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_runtime_class_list->api_version) == NULL) {
    goto fail; //String
    }
     } 
