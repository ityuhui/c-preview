...
cJSON *v1_csi_node_list_convertToJSON(v1_csi_node_list_t *v1_csi_node_list) {
    ...
    cJSON *itemLocal = v1_csi_node_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_csi_node_list_t *v1_csi_node_list_parseFromJSON(cJSON *v1_csi_node_listJSON){
    ...
    // v1_csi_node_list->items
    cJSON *items = cJSON_GetObjectItemCaseSensitive(v1_csi_node_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_csi_node_list->kind
    cJSON *kind = cJSON_GetObjectItemCaseSensitive(v1_csi_node_listJSON, "kind");
    if (kind) { 
