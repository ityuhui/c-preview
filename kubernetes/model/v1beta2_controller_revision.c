...
v1beta2_controller_revision_t *v1beta2_controller_revision_create(
    ...
    v1beta2_controller_revision_local_var->api_version = api_version;
...
cJSON *v1beta2_controller_revision_convertToJSON(v1beta2_controller_revision_t *v1beta2_controller_revision) {
    ...
    // v1beta2_controller_revision->api_version
    if(v1beta2_controller_revision->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta2_controller_revision->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta2_controller_revision_t *v1beta2_controller_revision_parseFromJSON(cJSON *v1beta2_controller_revisionJSON){
    ...
    // v1beta2_controller_revision->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta2_controller_revisionJSON, "apiVersion");
    if (api_version) { 
