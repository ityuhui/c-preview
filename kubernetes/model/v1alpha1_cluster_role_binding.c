...
v1alpha1_cluster_role_binding_t *v1alpha1_cluster_role_binding_create(
    ...
    v1alpha1_cluster_role_binding_local_var->api_version = api_version;
    v1alpha1_cluster_role_binding_local_var->kind = kind;
    v1alpha1_cluster_role_binding_local_var->metadata = metadata;
    v1alpha1_cluster_role_binding_local_var->role_ref = role_ref;
...
cJSON *v1alpha1_cluster_role_binding_convertToJSON(v1alpha1_cluster_role_binding_t *v1alpha1_cluster_role_binding) {
    ...
    if(v1alpha1_cluster_role_binding->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_cluster_role_binding->api_version) == NULL) {
    goto fail; //String
    }
     } 
    ...
    // v1alpha1_cluster_role_binding->role_ref
    if (!v1alpha1_cluster_role_binding->role_ref) {
        goto fail;
    }
    
    cJSON *role_ref_local_JSON = v1alpha1_role_ref_convertToJSON(v1alpha1_cluster_role_binding->role_ref);
    ...
    cJSON *itemLocal = rbac_v1alpha1_subject_convertToJSON(subjectsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1alpha1_cluster_role_binding_t *v1alpha1_cluster_role_binding_parseFromJSON(cJSON *v1alpha1_cluster_role_bindingJSON){
    ...
    // v1alpha1_cluster_role_binding->role_ref
    cJSON *role_ref = cJSON_GetObjectItemCaseSensitive(v1alpha1_cluster_role_bindingJSON, "roleRef");
    if (!role_ref) {
        goto end;
    }
    ...
    cJSON_ArrayForEach(subjects_local_nonprimitive,subjects )
    {
        ...
        rbac_v1alpha1_subject_t *subjectsItem = rbac_v1alpha1_subject_parseFromJSON(subjects_local_nonprimitive);
