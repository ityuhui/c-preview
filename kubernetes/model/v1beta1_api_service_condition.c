...
v1beta1_api_service_condition_t *v1beta1_api_service_condition_create(
    ...
    v1beta1_api_service_condition_local_var->last_transition_time = last_transition_time;
...
void v1beta1_api_service_condition_free(v1beta1_api_service_condition_t *v1beta1_api_service_condition) {
    ...
    free(v1beta1_api_service_condition->last_transition_time);
...
cJSON *v1beta1_api_service_condition_convertToJSON(v1beta1_api_service_condition_t *v1beta1_api_service_condition) {
    ...
    // v1beta1_api_service_condition->last_transition_time
    if(v1beta1_api_service_condition->last_transition_time) { 
    if(cJSON_AddStringToObject(item, "lastTransitionTime", v1beta1_api_service_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
     } 
...
v1beta1_api_service_condition_t *v1beta1_api_service_condition_parseFromJSON(cJSON *v1beta1_api_service_conditionJSON){
    ...
    // v1beta1_api_service_condition->last_transition_time
    cJSON *last_transition_time = cJSON_GetObjectItemCaseSensitive(v1beta1_api_service_conditionJSON, "lastTransitionTime");
