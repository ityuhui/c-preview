...
v1beta2_scale_t *v1beta2_scale_create(
    ...
    v1beta2_scale_local_var->api_version = api_version;
...
cJSON *v1beta2_scale_convertToJSON(v1beta2_scale_t *v1beta2_scale) {
    ...
    // v1beta2_scale->api_version
    if(v1beta2_scale->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta2_scale->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta2_scale_t *v1beta2_scale_parseFromJSON(cJSON *v1beta2_scaleJSON){
    ...
    // v1beta2_scale->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta2_scaleJSON, "apiVersion");
    if (api_version) { 
