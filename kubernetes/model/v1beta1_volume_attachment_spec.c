...
v1beta1_volume_attachment_spec_t *v1beta1_volume_attachment_spec_create(
    ...
    v1beta1_volume_attachment_spec_local_var->node_name = node_name;
...
void v1beta1_volume_attachment_spec_free(v1beta1_volume_attachment_spec_t *v1beta1_volume_attachment_spec) {
    ...
    free(v1beta1_volume_attachment_spec->node_name);
...
cJSON *v1beta1_volume_attachment_spec_convertToJSON(v1beta1_volume_attachment_spec_t *v1beta1_volume_attachment_spec) {
    ...
    // v1beta1_volume_attachment_spec->node_name
    if (!v1beta1_volume_attachment_spec->node_name) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "nodeName", v1beta1_volume_attachment_spec->node_name) == NULL) {
    goto fail; //String
    }
...
v1beta1_volume_attachment_spec_t *v1beta1_volume_attachment_spec_parseFromJSON(cJSON *v1beta1_volume_attachment_specJSON){
    ...
    // v1beta1_volume_attachment_spec->node_name
    cJSON *node_name = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attachment_specJSON, "nodeName");
    if (!node_name) {
        goto end;
    }
