...
v1alpha1_aggregation_rule_t *v1alpha1_aggregation_rule_create(
    ...
    v1alpha1_aggregation_rule_local_var->cluster_role_selectors = cluster_role_selectors;
...
cJSON *v1alpha1_aggregation_rule_convertToJSON(v1alpha1_aggregation_rule_t *v1alpha1_aggregation_rule) {
    ...
    // v1alpha1_aggregation_rule->cluster_role_selectors
    if(v1alpha1_aggregation_rule->cluster_role_selectors) { 
    ...
    if (v1alpha1_aggregation_rule->cluster_role_selectors) {
    list_ForEach(cluster_role_selectorsListEntry, v1alpha1_aggregation_rule->cluster_role_selectors) {
...
v1alpha1_aggregation_rule_t *v1alpha1_aggregation_rule_parseFromJSON(cJSON *v1alpha1_aggregation_ruleJSON){
    ...
    // v1alpha1_aggregation_rule->cluster_role_selectors
    cJSON *cluster_role_selectors = cJSON_GetObjectItemCaseSensitive(v1alpha1_aggregation_ruleJSON, "clusterRoleSelectors");
