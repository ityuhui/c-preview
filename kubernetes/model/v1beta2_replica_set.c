...
v1beta2_replica_set_t *v1beta2_replica_set_create(
    ...
    v1beta2_replica_set_local_var->api_version = api_version;
...
void v1beta2_replica_set_free(v1beta2_replica_set_t *v1beta2_replica_set) {
    ...
    free(v1beta2_replica_set->api_version);
...
cJSON *v1beta2_replica_set_convertToJSON(v1beta2_replica_set_t *v1beta2_replica_set) {
    ...
    // v1beta2_replica_set->api_version
    if(v1beta2_replica_set->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta2_replica_set->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta2_replica_set_t *v1beta2_replica_set_parseFromJSON(cJSON *v1beta2_replica_setJSON){
    ...
    // v1beta2_replica_set->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta2_replica_setJSON, "apiVersion");
    if (api_version) { 
