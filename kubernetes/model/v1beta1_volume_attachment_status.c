...
v1beta1_volume_attachment_status_t *v1beta1_volume_attachment_status_create(
    ...
    v1beta1_volume_attachment_status_local_var->attach_error = attach_error;
    v1beta1_volume_attachment_status_local_var->attached = attached;
    v1beta1_volume_attachment_status_local_var->attachment_metadata = attachment_metadata;
    v1beta1_volume_attachment_status_local_var->detach_error = detach_error;
...
cJSON *v1beta1_volume_attachment_status_convertToJSON(v1beta1_volume_attachment_status_t *v1beta1_volume_attachment_status) {
    ...
    // v1beta1_volume_attachment_status->attach_error
    if(v1beta1_volume_attachment_status->attach_error) { 
    cJSON *attach_error_local_JSON = v1beta1_volume_error_convertToJSON(v1beta1_volume_attachment_status->attach_error);
    ...
    // v1beta1_volume_attachment_status->attachment_metadata
    ...
    if (v1beta1_volume_attachment_status->attachment_metadata) {
    list_ForEach(attachment_metadataListEntry, v1beta1_volume_attachment_status->attachment_metadata) {
    ...
    // v1beta1_volume_attachment_status->detach_error
    if(v1beta1_volume_attachment_status->detach_error) { 
    cJSON *detach_error_local_JSON = v1beta1_volume_error_convertToJSON(v1beta1_volume_attachment_status->detach_error);
...
v1beta1_volume_attachment_status_t *v1beta1_volume_attachment_status_parseFromJSON(cJSON *v1beta1_volume_attachment_statusJSON){
    ...
    // v1beta1_volume_attachment_status->attach_error
    cJSON *attach_error = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attachment_statusJSON, "attachError");
    v1beta1_volume_error_t *attach_error_local_nonprim = NULL;
    if (attach_error) { 
    attach_error_local_nonprim = v1beta1_volume_error_parseFromJSON(attach_error); //nonprimitive
    }
    ...
    // v1beta1_volume_attachment_status->attachment_metadata
    cJSON *attachment_metadata = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attachment_statusJSON, "attachmentMetadata");
    ...
    // v1beta1_volume_attachment_status->detach_error
    cJSON *detach_error = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attachment_statusJSON, "detachError");
    v1beta1_volume_error_t *detach_error_local_nonprim = NULL;
    if (detach_error) { 
    detach_error_local_nonprim = v1beta1_volume_error_parseFromJSON(detach_error); //nonprimitive
    }
