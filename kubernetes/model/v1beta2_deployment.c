...
v1beta2_deployment_t *v1beta2_deployment_create(
    ...
    v1beta2_deployment_local_var->api_version = api_version;
...
cJSON *v1beta2_deployment_convertToJSON(v1beta2_deployment_t *v1beta2_deployment) {
    ...
    // v1beta2_deployment->api_version
    if(v1beta2_deployment->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta2_deployment->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta2_deployment_t *v1beta2_deployment_parseFromJSON(cJSON *v1beta2_deploymentJSON){
    ...
    // v1beta2_deployment->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta2_deploymentJSON, "apiVersion");
    if (api_version) { 
