...
void v1alpha1_policy_rule_free(v1alpha1_policy_rule_t *v1alpha1_policy_rule) {
    ...
    list_ForEach(listEntry, v1alpha1_policy_rule->api_groups) {
        free(listEntry->data);
    }
    ...
    list_free(v1alpha1_policy_rule->resource_names);
...
cJSON *v1alpha1_policy_rule_convertToJSON(v1alpha1_policy_rule_t *v1alpha1_policy_rule) {
    ...
    if(v1alpha1_policy_rule->api_groups) { 
    ...
    list_ForEach(api_groupsListEntry, v1alpha1_policy_rule->api_groups) {
    ...
    list_ForEach(resource_namesListEntry, v1alpha1_policy_rule->resource_names) {
