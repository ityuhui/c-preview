...
extensions_v1beta1_ingress_list_t *extensions_v1beta1_ingress_list_create(
    ...
    extensions_v1beta1_ingress_list_local_var->api_version = api_version;
...
cJSON *extensions_v1beta1_ingress_list_convertToJSON(extensions_v1beta1_ingress_list_t *extensions_v1beta1_ingress_list) {
    ...
    // extensions_v1beta1_ingress_list->api_version
    if(extensions_v1beta1_ingress_list->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", extensions_v1beta1_ingress_list->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
extensions_v1beta1_ingress_list_t *extensions_v1beta1_ingress_list_parseFromJSON(cJSON *extensions_v1beta1_ingress_listJSON){
    ...
    // extensions_v1beta1_ingress_list->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(extensions_v1beta1_ingress_listJSON, "apiVersion");
    if (api_version) { 
