...
v1beta2_rolling_update_daemon_set_t *v1beta2_rolling_update_daemon_set_create(
    ...
    v1beta2_rolling_update_daemon_set_local_var->max_unavailable = max_unavailable;
...
cJSON *v1beta2_rolling_update_daemon_set_convertToJSON(v1beta2_rolling_update_daemon_set_t *v1beta2_rolling_update_daemon_set) {
    ...
    // v1beta2_rolling_update_daemon_set->max_unavailable
    if(v1beta2_rolling_update_daemon_set->max_unavailable) { 
    cJSON *max_unavailable_object = object_convertToJSON(v1beta2_rolling_update_daemon_set->max_unavailable);
...
v1beta2_rolling_update_daemon_set_t *v1beta2_rolling_update_daemon_set_parseFromJSON(cJSON *v1beta2_rolling_update_daemon_setJSON){
    ...
    // v1beta2_rolling_update_daemon_set->max_unavailable
    cJSON *max_unavailable = cJSON_GetObjectItemCaseSensitive(v1beta2_rolling_update_daemon_setJSON, "maxUnavailable");
