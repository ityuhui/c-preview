...
apps_v1beta1_deployment_status_t *apps_v1beta1_deployment_status_create(
    ...
    apps_v1beta1_deployment_status_local_var->available_replicas = available_replicas;
    apps_v1beta1_deployment_status_local_var->collision_count = collision_count;
    apps_v1beta1_deployment_status_local_var->conditions = conditions;
    apps_v1beta1_deployment_status_local_var->observed_generation = observed_generation;
    apps_v1beta1_deployment_status_local_var->ready_replicas = ready_replicas;
    apps_v1beta1_deployment_status_local_var->replicas = replicas;
    apps_v1beta1_deployment_status_local_var->unavailable_replicas = unavailable_replicas;
    apps_v1beta1_deployment_status_local_var->updated_replicas = updated_replicas;
...
cJSON *apps_v1beta1_deployment_status_convertToJSON(apps_v1beta1_deployment_status_t *apps_v1beta1_deployment_status) {
    ...
    // apps_v1beta1_deployment_status->available_replicas
    if(apps_v1beta1_deployment_status->available_replicas) { 
    if(cJSON_AddNumberToObject(item, "availableReplicas", apps_v1beta1_deployment_status->available_replicas) == NULL) {
    goto fail; //Numeric
    }
     } 


    // apps_v1beta1_deployment_status->collision_count
    if(apps_v1beta1_deployment_status->collision_count) { 
    if(cJSON_AddNumberToObject(item, "collisionCount", apps_v1beta1_deployment_status->collision_count) == NULL) {
    goto fail; //Numeric
    }
     } 
    ...
    // apps_v1beta1_deployment_status->observed_generation
    if(apps_v1beta1_deployment_status->observed_generation) { 
    if(cJSON_AddNumberToObject(item, "observedGeneration", apps_v1beta1_deployment_status->observed_generation) == NULL) {
    goto fail; //Numeric
    }
     } 


    // apps_v1beta1_deployment_status->ready_replicas
    if(apps_v1beta1_deployment_status->ready_replicas) { 
    if(cJSON_AddNumberToObject(item, "readyReplicas", apps_v1beta1_deployment_status->ready_replicas) == NULL) {
    goto fail; //Numeric
    }
     } 
    ...
    // apps_v1beta1_deployment_status->unavailable_replicas
    if(apps_v1beta1_deployment_status->unavailable_replicas) { 
    if(cJSON_AddNumberToObject(item, "unavailableReplicas", apps_v1beta1_deployment_status->unavailable_replicas) == NULL) {
    goto fail; //Numeric
    }
     } 


    // apps_v1beta1_deployment_status->updated_replicas
    if(apps_v1beta1_deployment_status->updated_replicas) { 
    if(cJSON_AddNumberToObject(item, "updatedReplicas", apps_v1beta1_deployment_status->updated_replicas) == NULL) {
    goto fail; //Numeric
    }
     } 
...
apps_v1beta1_deployment_status_t *apps_v1beta1_deployment_status_parseFromJSON(cJSON *apps_v1beta1_deployment_statusJSON){
    ...
    // apps_v1beta1_deployment_status->available_replicas
    cJSON *available_replicas = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "availableReplicas");
    ...
    // apps_v1beta1_deployment_status->collision_count
    cJSON *collision_count = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "collisionCount");
    if (collision_count) { 
    ...
    // apps_v1beta1_deployment_status->observed_generation
    cJSON *observed_generation = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "observedGeneration");
    ...
    // apps_v1beta1_deployment_status->ready_replicas
    cJSON *ready_replicas = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "readyReplicas");
    if (ready_replicas) { 
    ...
    // apps_v1beta1_deployment_status->unavailable_replicas
    cJSON *unavailable_replicas = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "unavailableReplicas");
    ...
    // apps_v1beta1_deployment_status->updated_replicas
    cJSON *updated_replicas = cJSON_GetObjectItemCaseSensitive(apps_v1beta1_deployment_statusJSON, "updatedReplicas");
    if (updated_replicas) { 
