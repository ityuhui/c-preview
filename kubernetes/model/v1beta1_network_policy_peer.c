...
v1beta1_network_policy_peer_t *v1beta1_network_policy_peer_create(
    ...
    v1beta1_network_policy_peer_local_var->ip_block = ip_block;
    v1beta1_network_policy_peer_local_var->namespace_selector = namespace_selector;
    v1beta1_network_policy_peer_local_var->pod_selector = pod_selector;
...
cJSON *v1beta1_network_policy_peer_convertToJSON(v1beta1_network_policy_peer_t *v1beta1_network_policy_peer) {
    ...
    // v1beta1_network_policy_peer->ip_block
    if(v1beta1_network_policy_peer->ip_block) { 
    cJSON *ip_block_local_JSON = v1beta1_ip_block_convertToJSON(v1beta1_network_policy_peer->ip_block);
    ...
    // v1beta1_network_policy_peer->namespace_selector
    if(v1beta1_network_policy_peer->namespace_selector) { 
    cJSON *namespace_selector_local_JSON = v1_label_selector_convertToJSON(v1beta1_network_policy_peer->namespace_selector);
    ...
    // v1beta1_network_policy_peer->pod_selector
    if(v1beta1_network_policy_peer->pod_selector) { 
    cJSON *pod_selector_local_JSON = v1_label_selector_convertToJSON(v1beta1_network_policy_peer->pod_selector);
...
v1beta1_network_policy_peer_t *v1beta1_network_policy_peer_parseFromJSON(cJSON *v1beta1_network_policy_peerJSON){
    ...
    // v1beta1_network_policy_peer->ip_block
    cJSON *ip_block = cJSON_GetObjectItemCaseSensitive(v1beta1_network_policy_peerJSON, "ipBlock");
    v1beta1_ip_block_t *ip_block_local_nonprim = NULL;
    if (ip_block) { 
    ip_block_local_nonprim = v1beta1_ip_block_parseFromJSON(ip_block); //nonprimitive
    }

    // v1beta1_network_policy_peer->namespace_selector
    cJSON *namespace_selector = cJSON_GetObjectItemCaseSensitive(v1beta1_network_policy_peerJSON, "namespaceSelector");
    ...
    // v1beta1_network_policy_peer->pod_selector
    cJSON *pod_selector = cJSON_GetObjectItemCaseSensitive(v1beta1_network_policy_peerJSON, "podSelector");
