...
v1beta1_cluster_role_t *v1beta1_cluster_role_create(
    ...
    v1beta1_cluster_role_local_var->aggregation_rule = aggregation_rule;
    v1beta1_cluster_role_local_var->api_version = api_version;
...
cJSON *v1beta1_cluster_role_convertToJSON(v1beta1_cluster_role_t *v1beta1_cluster_role) {
    ...
    // v1beta1_cluster_role->aggregation_rule
    if(v1beta1_cluster_role->aggregation_rule) { 
    cJSON *aggregation_rule_local_JSON = v1beta1_aggregation_rule_convertToJSON(v1beta1_cluster_role->aggregation_rule);
    ...
    // v1beta1_cluster_role->api_version
    if(v1beta1_cluster_role->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_cluster_role->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_cluster_role_t *v1beta1_cluster_role_parseFromJSON(cJSON *v1beta1_cluster_roleJSON){
    ...
    // v1beta1_cluster_role->aggregation_rule
    cJSON *aggregation_rule = cJSON_GetObjectItemCaseSensitive(v1beta1_cluster_roleJSON, "aggregationRule");
    v1beta1_aggregation_rule_t *aggregation_rule_local_nonprim = NULL;
    if (aggregation_rule) { 
    aggregation_rule_local_nonprim = v1beta1_aggregation_rule_parseFromJSON(aggregation_rule); //nonprimitive
    }

    // v1beta1_cluster_role->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_cluster_roleJSON, "apiVersion");
    if (api_version) { 
