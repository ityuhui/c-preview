...
v1beta1_replica_set_list_t *v1beta1_replica_set_list_create(
    ...
    v1beta1_replica_set_list_local_var->api_version = api_version;
...
void v1beta1_replica_set_list_free(v1beta1_replica_set_list_t *v1beta1_replica_set_list) {
    ...
    free(v1beta1_replica_set_list->api_version);
...
cJSON *v1beta1_replica_set_list_convertToJSON(v1beta1_replica_set_list_t *v1beta1_replica_set_list) {
    ...
    // v1beta1_replica_set_list->api_version
    if(v1beta1_replica_set_list->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_replica_set_list->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_replica_set_list_t *v1beta1_replica_set_list_parseFromJSON(cJSON *v1beta1_replica_set_listJSON){
    ...
    // v1beta1_replica_set_list->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_replica_set_listJSON, "apiVersion");
    if (api_version) { 
