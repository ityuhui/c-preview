...
v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_create(
    ...
    v1beta1_aggregation_rule_local_var->cluster_role_selectors = cluster_role_selectors;
...
void v1beta1_aggregation_rule_free(v1beta1_aggregation_rule_t *v1beta1_aggregation_rule) {
    ...
    list_free(v1beta1_aggregation_rule->cluster_role_selectors);
...
cJSON *v1beta1_aggregation_rule_convertToJSON(v1beta1_aggregation_rule_t *v1beta1_aggregation_rule) {
    ...
    // v1beta1_aggregation_rule->cluster_role_selectors
    if(v1beta1_aggregation_rule->cluster_role_selectors) { 
    ...
    if (v1beta1_aggregation_rule->cluster_role_selectors) {
    list_ForEach(cluster_role_selectorsListEntry, v1beta1_aggregation_rule->cluster_role_selectors) {
...
v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_parseFromJSON(cJSON *v1beta1_aggregation_ruleJSON){
    ...
    // v1beta1_aggregation_rule->cluster_role_selectors
    cJSON *cluster_role_selectors = cJSON_GetObjectItemCaseSensitive(v1beta1_aggregation_ruleJSON, "clusterRoleSelectors");
