...
v1alpha1_cluster_role_t *v1alpha1_cluster_role_create(
    ...
    v1alpha1_cluster_role_local_var->aggregation_rule = aggregation_rule;
    v1alpha1_cluster_role_local_var->api_version = api_version;
...
cJSON *v1alpha1_cluster_role_convertToJSON(v1alpha1_cluster_role_t *v1alpha1_cluster_role) {
    ...
    if(v1alpha1_cluster_role->aggregation_rule) { 
    cJSON *aggregation_rule_local_JSON = v1alpha1_aggregation_rule_convertToJSON(v1alpha1_cluster_role->aggregation_rule);
    ...
    // v1alpha1_cluster_role->api_version
    if(v1alpha1_cluster_role->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_cluster_role->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1alpha1_cluster_role_t *v1alpha1_cluster_role_parseFromJSON(cJSON *v1alpha1_cluster_roleJSON){
    ...
    // v1alpha1_cluster_role->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1alpha1_cluster_roleJSON, "apiVersion");
    if (api_version) { 
