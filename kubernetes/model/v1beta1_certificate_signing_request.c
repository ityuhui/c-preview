...
v1beta1_certificate_signing_request_t *v1beta1_certificate_signing_request_create(
    ...
    v1beta1_certificate_signing_request_local_var->api_version = api_version;
...
cJSON *v1beta1_certificate_signing_request_convertToJSON(v1beta1_certificate_signing_request_t *v1beta1_certificate_signing_request) {
    ...
    // v1beta1_certificate_signing_request->api_version
    if(v1beta1_certificate_signing_request->api_version) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_certificate_signing_request->api_version) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_certificate_signing_request_t *v1beta1_certificate_signing_request_parseFromJSON(cJSON *v1beta1_certificate_signing_requestJSON){
    ...
    // v1beta1_certificate_signing_request->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_certificate_signing_requestJSON, "apiVersion");
    if (api_version) { 
