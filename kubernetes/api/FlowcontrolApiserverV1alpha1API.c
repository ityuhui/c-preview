...
#include <stdio.h>
#include <ctype.h>
#include "FlowcontrolApiserverV1alpha1API.h"
...
FlowcontrolApiserverV1alpha1API_createFlowSchema(apiClient_t *apiClient, v1alpha1_flow_schema_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_flow_schema_convertToJSON(body);
    ...
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_flow_schema_t *elementToReturn = v1alpha1_flow_schema_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
...
FlowcontrolApiserverV1alpha1API_createPriorityLevelConfiguration(apiClient_t *apiClient, v1alpha1_priority_level_configuration_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_priority_level_configuration_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_priority_level_configuration_t *elementToReturn = v1alpha1_priority_level_configuration_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1alpha1API_deleteCollectionFlowSchema(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , int timeoutSeconds , int watch , v1_delete_options_t * body )
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1alpha1API_deleteFlowSchema(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}");
...
FlowcontrolApiserverV1alpha1API_deletePriorityLevelConfiguration(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}");
...
FlowcontrolApiserverV1alpha1API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/");
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1alpha1API_listFlowSchema(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_flow_schema_list_t *elementToReturn = v1alpha1_flow_schema_list_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1alpha1API_listPriorityLevelConfiguration(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_priority_level_configuration_list_t *elementToReturn = v1alpha1_priority_level_configuration_list_parseFromJSON(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1alpha1API_patchFlowSchemaStatus(apiClient_t *apiClient, char * name , object_t * body , char * pretty , char * dryRun , char * fieldManager , int force )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/flowschemas/{name}/status");
...
FlowcontrolApiserverV1alpha1API_patchPriorityLevelConfigurationStatus(apiClient_t *apiClient, char * name , object_t * body , char * pretty , char * dryRun , char * fieldManager , int force )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1alpha1/prioritylevelconfigurations/{name}/status");
